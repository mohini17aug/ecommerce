...
class DetailActivity : AppCompatActivity() {
    ...
    private var productList = listOf<Product>() // Populate this list with your items
        ...
        productList = when (categoryName) {
            "Male Fashion" -> listOf(
                Product(
                    ...
                    "Partywear Sherwani",
                    2119.00,
                    R.drawable.men_sherwani
                ),
                Product(
                    12,
                    "Men's Shirt",
                    "Comfortable formal shirt",
                    1199.00,
            ...
            "Kids Fashion" -> listOf(
                ...
                Product(
                    33,
                    "Kid's dress",
                    "Stylish boys partywear",
                    599.00,
                    R.drawable.boys_dress3
                ),
                Product(
                    34,
                    "Kid's Tshirt",
                    "Comfortable Boys T-shirt",
                    229.00,
                    R.drawable.boys_tshirt
                ),
                Product(
                    35,
                    "Girl's dress",
                    "Girl's beautiful lehnga",
                    1239.00,
                    R.drawable.girls_dress1
                ),
                Product(
                    36,
                    "Girl's dress",
                    "Girl's partywear frock",
                    839.00,
                    R.drawable.girls_frock
                ),
                Product(
                    37,
                    "Girl's dress",
            ...
            "Misc" -> listOf(
                Product(
                    41,
                    "Bedsheet",
                    "Silk Bedsheet with 2 pillow cover",
                    899.00,
                    R.drawable.home1
                ),
                ...
                Product(
                    44,
                    "Bedsheet",
                    "Beautiful 5 piece bedsheet with blanket",
                    1119.00,
                    R.drawable.home4
                ),
    ...
    private fun filterItems(text: String?) {
        val filteredList = productList.filter {
         ...
         Log.d("DetailActivity", "Filtering for query: $text  filtered count: ${filteredList.size}")

        productAdapter.filterList(filteredList)
    }
    private fun openProductView(product: Product) {
